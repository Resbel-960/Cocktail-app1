...
from .serializers import Cocktail, ElasticCocktailSerializer


@receiver(pre_save, sender=Blog, dispatch_uid="update_record")
def update_es_record(sender, instance, **kwargs):
    obj = ElasticCocktailSerializer(instance)
    obj.save(using=es_client)


@receiver(post_delete, sender=Cocktail, dispatch_uid="delete_record")
